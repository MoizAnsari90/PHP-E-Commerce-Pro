...
<html lang="en">
    ...
    <body>		
		...
		<div id="wrapper" class="container">
				...
				<div class="navbar-inner main-menu">				
					...
					<nav id="menu" class="pull-right">
						<ul>
							...
							<li><a href="./products.php">Brand</a>
							<ul>
									<?php
									$ban  = mysqli_query($con ,"SELECT * FROM `brand`");
									while($row1 = mysqli_fetch_Array($ban)){
										?>
											<li><a href="showbrand.php?brand_id=<?php echo $row1[0]?>"><?php echo $row1[1]?></a></li>
									<?php }
									?>								
							</ul>
							</li>			
			...
			<img class="pageBanner" src="themes/images/slider.jpg"  alt="New products" >
				<h4><span><h1>Product Detail</h1></span></h4>
			</section>
				...
				<div class="row">						
					<div class="span9">
						<div class="row">
							...
							{
								$detpro = $_GET["detailid"];
								
								$fetchpro = mysqli_query($con, "SELECT * FROM `product` WHERE Pid= '$detpro'"); 
								$row1 = mysqli_fetch_Array($fetchpro);
								?>

							
							<div class="span4">
								<a href="Admin/proimage/<?php echo $row1[7]?>" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="Admin/proimage/<?php echo $row1[7]?>"></a>												
							...
							<div class="span5">
								<address>
									<h4><strong>Product Name:</strong> <span><?php echo $row1[1] ?></span></h4><br>
									<h4><strong>Product Code:</strong> <span>Product 14</span></h4><br>
									<h4><strong>Detail:</strong> <span><?php echo $row1[6] ?></span></h4><br>
									<h4><strong>Availability:</strong> <span><?php echo $row1[5] ?></span></h4><br>								
								</address>									
								<h4><strong>Rs: <?php echo $row1[4]?>/-</strong></h4>
							</div>
							...
							<div class="span5">
								<form class="form-inline">
									...
									<!-- <button class="btn btn-inverse" type="submit" a>Add to cart</button> -->
									<!-- <a href="cart.php?add_to_cart=<?php echo $row1[0]?>" class="btn btn-inverse" type="submit" >Add to cart</a> -->
									<a href="https://www.facebook.com/profile.php?id=61555922305149&mibextid=ZbWKwL" class="btn btn-inverse" type="submit" >Add to cart</a>
								</form>
							</div>							
						</div>
						<?php } ?>
											...
											<ul class="thumbnails listing-products">
												<li class="span3">
													<div class="product-box">
														...
														<a href="product_detail.html"><img alt="" src="Admin/proimage/123.jpg"></a><br/>
														<a href="product_detail.html" class="title">Wuam ultrices rutrum</a><br/>
														<a href="#" class="category">Suspendisse aliquet</a>
														<h4 class="price">Rs : 2700/-</h4>
													</div>
												</li>
												<li class="span3">
													<div class="product-box">
														<span class="sale_tag"></span>												
														<a href="product_detail.html"><img alt="" src="Admin/proimage/1234.jpg"></a><br/>
												...
												<li class="span3">
													<div class="product-box">												
														<a href="product_detail.html"><img alt="" src="Admin/proimage/abc.jpg"></a><br/>
									...
									<div class="active item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													<span class="sale_tag"></span>												
													<a href="product_detail.html"><img alt="" src="Admin/proimage/123456.jpg"></a><br/>
													<a href="product_detail.html" class="title">Fusce id molestie massa</a><br/>
													<a href="#" class="category">Suspendisse aliquet</a>
													<h4 class="price">Rs : 2700/-</h4>
												</div>
							...
							<ul class="small-product">
								<li>
									<a href="#" title="Praesent tempor sem sodales">
										<img src="Admin/proimage/123456.jpg" alt="Praesent tempor sem sodales">
									</a>
									<a href="#">Praesent tempor sem</a>
								</li>
								<li>
									<a href="#" title="Luctus quam ultrices rutrum">
										<img src="Admin/proimage/123456.jpg" alt="Luctus quam ultrices rutrum">
									</a>
									<a href="#">Luctus quam ultrices rutrum</a>
								</li>
								<li>
									<a href="#" title="Fusce id molestie massa">
										<img src="Admin/proimage/abc.jpg" alt="Fusce id molestie massa">
									</a>
