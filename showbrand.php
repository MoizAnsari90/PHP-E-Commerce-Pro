						...
						<li><a href="./index.php">woman</a>
							...
							<ul>
									...
									while($row1 = mysqli_fetch_Array($ban)){
										?>
											<li><a href="showbrand.php?brandID=<?php echo $row1[0]?>"><?php echo $row1[1]?></a></li>
									<?php }
									?>								
							</ul>
							</li>			
				...
				<div class="row">						
					<div class="span9">								
						<ul class="thumbnails listing-products">
								...
								{
									$bid = $_GET["brandID"];
									$showban = mysqli_query($con, "SELECT * FROM `product` WHERE `brand_id` = '$bid' ");
									while($pp = mysqli_fetch_Array($showban))
									{
									?>
									<li class="span3">
									<div class="product-box">
									<span class="sale_tag"></span>												
									<a href="product_detail.php?detailid=<?php echo $pp[0]?>"><img src="Admin/proimage/<?php echo $pp[7]?>" alt="" ></a><br/>
									<a href="product_detail.php?detailid=<?php echo $pp[0]?>" class="title"><?php echo $pp[1]?></a><br/>
									<a href="#" class="category"><?php echo $pp[6]?></a>
									<h4 class="price">Rs : 3700/-</h4>
									</div>
									</li>
									...
									<div class="active item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													<span class="sale_tag"></span>												
													<img alt="" src="Admin/proimage/123456.jpg"><br/>
													<a href="product_detail.html" class="title">Fusce id molestie massa</a><br/>
													<a href="#" class="category">Suspendisse aliquet</a>
													<h4 class="price">Rs : 3700/-</h4>
												</div>
							...
							<ul class="small-product">
								<li>
									<a href="#" title="Praesent tempor sem sodales">
										<img src="Admin/proimage/123.jpg" alt="Praesent tempor sem sodales">
									</a>
								...
								<li>
									<a href="#" title="Fusce id molestie massa">
										<img src="Admin/proimage/12356.jpg" alt="Fusce id molestie massa">
									</a>
