					...
					<div class="span9">								
						<ul class="thumbnails listing-products">
								...
								while($row = mysqli_fetch_Array($pro))
								{
									...
									<a href="product_detail.php?detailid=<?php echo $row[0]?>"><img src="Admin/proimage/<?php echo $row[7]?>" alt="" ></a><br/>
									...
									<h4 class="price"><?php echo $row[4]?></h4>
									</div>
									</li> 
								<?php }
								?>
							...
							<ul class="small-product">
								...
								<li>
									<a href="#" title="Luctus quam ultrices rutrum">
										<img src="Admin/proimage/1234.jpg" alt="Luctus quam ultrices rutrum">
									</a>
